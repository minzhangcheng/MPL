...
def parameterJoin(neckedParameters, shortParameters, longParameters, join=' ', sep=' ', shortPrefix='-', longPrefix='--'):
    s = []
    if neckedParameters:
        s.extend(neckedParameters)
    if shortParameters:
        for i in shortParameters:
            s.append('{}{}{}{}'.format(shortPrefix, i, join, shortParameters[i]))
    if longParameters:
        for i in longParameters:
            s.append('{}{}{}{}'.format(longPrefix, i, join, longParameters[i]))
    return sep.join(s)
